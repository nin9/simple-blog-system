...
<body class="permission_denied">
    ...
    <div class="denied__wrapper">
      <h1>404</h1>
      <h3>LOST IN <span>SPACE</span> {{ config('app.name', 'Laravel') }}? Hmm, looks like that page doesn't exist.</h3>
      ...
      <a href="{{route('PostIndex')}}"><button class="denied__link">Go Home</button></a>
    </div>
    <script>
       var particles = {
      "particles": {
